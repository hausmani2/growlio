...
const Sidebar = ({ menuItems = [], mobileMenuOpen = false, onMobileMenuToggle }) => {
  ...
  const pathKeyMap = {
    ...
    '/onboarding/connect-pos': 'connect-pos',
    ...
    '/simulation/basic-information': 'simulation-basic-information',
    '/simulation/sales-channels-operating-days': 'simulation-sales-channels-operating-days',
    '/simulation/labor-information': 'simulation-labor-information',
